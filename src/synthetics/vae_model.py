...
class VAEModel:
    ...
    def __init__(self, dataset, architecture="VAE"):
        ...
        if architecture == "VAE":
            ...
            self.model = CNNVAe(input_length=Hyperparameter.INPUT_DIM,
    ...
    def train_vae(self):
        ...
        for epoch in range(Hyperparameter.NUM_EPOCHS):
            ...
            if (epoch + 1) % 250 == 0:
                ...
                self.visualize_latent_space_sampling(x[idx].cpu().numpy(), self.model, device=Hyperparameter.DEVICE,
                                                     latent_dim=Hyperparameter.LATENT_DIM, steps=10,
    ...
    def visualize_latent_space_sampling(self, original, model, device, latent_dim, steps=10, save_prefix="latent"):
