...
dist_isotope_per_pm = spi.API().view_isotope_per_pm()
dist_isotope_per_ps = spi.API().view_isotope_per_ps()
...
count_dist_isotope_per_pm = px.histogram(
    dist_isotope_per_pm.groupby("row_count").count().reset_index(),
    x='row_count',
    y='datetime',
    nbins=40,
    title="Found Isotopes Distributions Counts",
)

count_dist_isotope_per_ps = px.histogram(
    dist_isotope_per_ps.groupby("row_count").count().reset_index(),
    x='row_count',
    y='datetime',
    nbins=40,
    title="Found Isotopes Distributions Counts",
...
sidebar = dbc.Col(
    [
        html.A(html.Button('Refresh Data'), href='/processed'),
    ],
    style={
        "position": "fixed",
        "top": 72,
...
content = dbc.Col(
    [
        ...
        dbc.Row(dcc.Graph(figure=count_dist_isotope_per_pm)),
        dbc.Row(dcc.Graph(figure=count_dist_isotope_per_ps)),
    ],
    style={
        "marginLeft": "370px",
        "padding": "20px",
